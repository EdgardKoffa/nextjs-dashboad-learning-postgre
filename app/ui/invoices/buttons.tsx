...
export const UpdateInvoice = ({id}:{id:string}) => {
   ...
   return <Link href="/dashboard/invoices" className=' rounded p-2 border  border-orange-500 text-orange-400 hover:border-none hover:text-white hover:bg-orange-300'>
